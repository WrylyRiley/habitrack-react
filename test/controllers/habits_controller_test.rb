...
class HabitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create habit" do
    assert_difference('Habit.count') do
      post habits_url, params: { habit: { motivation: @habit.motivation, name: @habit.name, time_scale: @habit.time_scale, type: @habit.type, user_id: @habit.user_id } }
    end
  ...
  test "should update habit" do
    patch habit_url(@habit), params: { habit: { motivation: @habit.motivation, name: @habit.name, time_scale: @habit.time_scale, type: @habit.type, user_id: @habit.user_id } }
